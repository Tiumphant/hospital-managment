...
const getOne = async () => {
    try {
        ...
        console.log("Error in fetching department:", error.response?.data || error.message);
    }
};
...
<div className="mb-3">
    <input type="text" className='form-control'  placeholder='department name' value={name} onChange={(e)=> setName(e.target.value)} required/>
</div>
<div className="mb-3">
...
<div className="mb-3">
<select className="form-control" value={head_doctor_id} onChange={(e) => setHead_Doctor_Id(e.target.value)}>
...
<div className="d-flex justify-content-between">
            <button type="submit" onSubmit={(e) => handleSubmit(e)} className="btn btn-success btn-lg animate-button">Submit</button>
            {id && (
              <>
