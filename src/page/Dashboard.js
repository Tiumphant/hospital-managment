        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            {!auth ? (
              ...
              <>
                <Nav.Link as={Link} to="/homeadmin">
                  Home
                </Nav.Link>

                <NavDropdown title="Patient" id="patient-dropdown">
                  <NavDropdown.Item as={Link} to="/patientC">
                    Add Patient
                  </NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/patientlistK">
                    Patient List
                  </NavDropdown.Item>
                </NavDropdown>

                <NavDropdown title="Department" id="department-dropdown">
                  <NavDropdown.Item as={Link} to="/departmentC">
                    Add Department
                  </NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/departmentlistK">
                    Department List
                  </NavDropdown.Item>
                </NavDropdown>

                <NavDropdown title="Appointment" id="appointment-dropdown">
                  <NavDropdown.Item as={Link} to="/appointmentC">
                    Add Appointment
                  </NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/appointmentlistK">
                    Appointment List
                  </NavDropdown.Item>
                </NavDropdown>

                <NavDropdown title="Doctor" id="doctor-dropdown">
                  <NavDropdown.Item as={Link} to="/roleC">
                    Add Role
                  </NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/rolelistK">
                    Role List
                  </NavDropdown.Item>
                </NavDropdown>
